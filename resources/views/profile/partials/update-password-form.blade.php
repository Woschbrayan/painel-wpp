<section style="background-color: #ffffff; padding: 24px; border-radius: 12px; box-shadow: 0 2px 8px rgba(0,0,0,0.05);">
    <header>
        ...
        <p class="mt-1 text-sm text-gray-600">
            {{ __('Garanta que sua conta esteja usando uma senha longa e segura.') }}
        </p>
    </header>
